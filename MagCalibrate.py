...
# A = np.array([[0.000814,0.000016,-0.000000],[0.000016,0.000776,-0.000026],[-0.000000,-0.000026,0.000849]])

# raw3
# b = np.array([-41.075228, -19.023585, 1.356729])
# A = np.array([[1.617812,-0.026007,0.251062],[-0.026007,1.652689,0.086111],[0.251062,0.086111,1.241890]])
# x1,y1,z1 = CalibratePlot(b,A,"Hard and Soft Iron Compensation Calibration Results")
# comparePlot(x,y,x1,y1)


# b1 = np.array([-12.825291, -17.877001, -42.370841])
# A1 = np.array(  [[0.000946,0.000021,-0.000087],
#                 [0.000021,0.000840,-0.000048],
#                 [-0.000087,-0.000048,0.000857]])
